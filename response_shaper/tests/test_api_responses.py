...
class TestAPIResponses:
    ...
    def test_hateoas_api_response(self, api_client: APIClient) -> None:
        ...
        response = hateoas_api_response(success=True, message="Operation successful", data={"id": 1}, links=links)
        ...
        assert response.data["links"]["related"] == "https://api.example.com/resource/1/related"
    ...
    def test_multi_resource_response(self, api_client: APIClient) -> None:
        ...
        response = multi_resource_response(success=True, message="Multiple resources fetched", resources=resources)
        assert response.status_code == status.HTTP_200_OK
        assert response.data["status"] == "success"
    ...
    def test_api_response(self, api_client: APIClient) -> None:
        ...
        :param api_client: Fixture for APIClient.
        """
        response = api_response(success=True, message="Operation successful", data={"key": "value"}, errors=None)
        assert response.status_code == status.HTTP_200_OK
        assert response.data["status"] == "success"
        assert response.data["message"] == "Operation successful"
    ...
    def test_error_api_response(self, api_client: APIClient) -> None:
        ...
        :param api_client: Fixture for APIClient.
        """
        response = error_api_response(message="Validation error", errors={"field": "This field is required"}, error_code="ERR01")
    ...
    def test_batch_api_response(self, api_client: APIClient) -> None:
        ...
        response = batch_api_response(success=True, message="Batch processed", results=results)
        assert response.status_code == status.HTTP_200_OK
        assert response.data["status"] == "success"
    ...
    def test_upload_progress_response(self, api_client: APIClient) -> None:
        ...
        :param api_client: Fixture for APIClient.
        """
        response = upload_progress_response(success=True, message="Upload in progress", progress=50)
        assert response.status_code == status.HTTP_200_OK
    ...
    def test_service_availability_response(self, api_client: APIClient) -> None:
        ...
        :param api_client: Fixture for APIClient.
        """
        response = service_availability_response(available=True, message="Service is running", service_name="Database")
        assert response.status_code == status.HTTP_200_OK
    ...
    def test_redirect_response(self, api_client: APIClient) -> None:
        ...
        :param api_client: Fixture for APIClient.
        """
        response = redirect_response(message="Resource moved", redirect_url="https://new-url.com")
